            ...
            <form
                ...
                <div>
                    <label for="email" class="block text-sm font-medium leading-6 text-gray-900">Email
                        address</label>
                    <div class="mt-2">
                        <input dusk="email" id="email" name="email" wire:model="form.email"
                               type="email"
                               autocomplete="email"
                               required
                               class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                    </div>
                    <x-input-error dusk="email-error" :messages="$errors->get('form.email')" class="mt-2"/>
                </div>

                <div>
                    <label dusk="password" for="password" class="block text-sm font-medium leading-6 text-gray-900">Password</label>
                    <div class="mt-2">
                        <input dusk="password" id="password" name="password" wire:model="form.password"
                               type="password"
