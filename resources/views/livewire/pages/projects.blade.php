...
>
    ...
    <p class="text-3xl font-bold leading-tight tracking-tight text-gray-900">Liste des projets</p>
    <div>
        ...
        @else
            <div class="mt-10 flex items-center text-center justify-center">
                <div class="">
                    ...
                    <p class="mt-2 text-sm font-semibold text-gray-900">Aucun projet créé</p>
